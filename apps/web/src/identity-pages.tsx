...
function issuerUpdateBody(issuer: ExternalIdentityIssuer): JsonValue {
  return {
    ...
    management_capability_ceiling: issuer.management_capability_ceiling,
    management_organization_ceiling: issuer.management_organization_ceiling,
    llm_scope_ceiling: issuer.llm_scope_ceiling,
    llm_capability_ceiling: issuer.llm_capability_ceiling,
